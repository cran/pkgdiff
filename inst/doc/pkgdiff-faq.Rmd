...
to compare two packages locally. This package can generated version differences.
...
used packages.
For instance, `pkg_info()` produces no results for "tools" and "utils".  Does
...
"grDevices", "grid", "methods", "stats", etc. will give a message saying package
data was not found.  Data for these packages is indeed not found in the same
area as most CRAN packages.
